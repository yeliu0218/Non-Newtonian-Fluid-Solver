...
if( out==1 ) set output "cutline4.eps" ;
...
plot "cutline_00004.txt" using 3:5 title "analytic" with lines,\
     "cutline_00004.txt" using 3:4 title "computed" with lines 
