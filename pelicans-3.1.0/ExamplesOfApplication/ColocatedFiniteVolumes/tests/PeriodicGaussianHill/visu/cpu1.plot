...
if( out==1 ) set output "cutline1.eps" ;
...
plot "cutline_00001.txt" using 3:5 title "analytic" with lines,\
     "cutline_00001.txt" using 3:4 title "computed" with lines 
