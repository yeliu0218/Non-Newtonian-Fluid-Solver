package Pod::LaTeX;
# Add by Lionel CHAILAN (and subsequent)
my $replacement = 0 ;
use diagnostics ;
#
=head1 NAME
...
sub end_pod {
  ...
  warn( "No replacement done : try to clean NAME section" ) 
    if $replacement!=$self->ReplaceNAMEwithSection() ;
  $self->_output($end);
...
$Id: LaTeX.pm,v 1.2 2008-01-03 10:14:30 piar Exp $
