...
MODULE FE_OneStepIteration#concentration
            concrete_name = "DC_PLIC_Advection"
...
class DC_PLIC_Advection : public FE_OneStepIteration
{
   public: //-----------------------------------------------------------------
   ...
   private: //----------------------------------------------------------------
       ...
       ~DC_PLIC_Advection( void ) ;
        DC_PLIC_Advection( DC_PLIC_Advection const& other ) ;
        DC_PLIC_Advection& operator=( DC_PLIC_Advection const& other ) ;

        DC_PLIC_Advection( PEL_Object* a_owner,
   ...
   //-- Plug in
        ...
        virtual DC_PLIC_Advection* create_replica( PEL_Object* a_owner,
				      PDE_DomainAndFields const* dom,
				      FE_SetOfParameters const* prms,
  ...
  //-- Class attributes
        ...
        static DC_PLIC_Advection const* PROTOTYPE ;
