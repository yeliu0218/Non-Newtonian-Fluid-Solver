...
MODULE FE_OneStepIteration#concentration
            concrete_name = "P3_PLIC_Advection"
...
class P3_PLIC_Advection : public FE_OneStepIteration
{
   public: //-----------------------------------------------------------------
   ...
   private: //----------------------------------------------------------------
       ...
       ~P3_PLIC_Advection( void ) ;
        P3_PLIC_Advection( P3_PLIC_Advection const& other ) ;
        P3_PLIC_Advection& operator=( P3_PLIC_Advection const& other ) ;

        P3_PLIC_Advection( PEL_Object* a_owner,
   ...
   //-- Plug in
        ...
        virtual P3_PLIC_Advection* create_replica( PEL_Object* a_owner,
				      PDE_DomainAndFields const* dom,
				      FE_SetOfParameters const* prms,
  ...
  //-- Class attributes
        ...
        static P3_PLIC_Advection const* PROTOTYPE ;
