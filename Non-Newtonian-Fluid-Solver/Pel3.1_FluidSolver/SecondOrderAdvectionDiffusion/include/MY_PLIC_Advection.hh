...
MODULE FE_OneStepIteration#concentration
            concrete_name = "MY_PLIC_Advection"
...
class MY_PLIC_Advection : public FE_OneStepIteration
{
   public: //-----------------------------------------------------------------
   ...
   private: //----------------------------------------------------------------
       ...
       ~MY_PLIC_Advection( void ) ;
        MY_PLIC_Advection( MY_PLIC_Advection const& other ) ;
        MY_PLIC_Advection& operator=( MY_PLIC_Advection const& other ) ;

        MY_PLIC_Advection( PEL_Object* a_owner,
   ...
   //-- Plug in
        ...
        virtual MY_PLIC_Advection* create_replica( PEL_Object* a_owner,
				      PDE_DomainAndFields const* dom,
				      FE_SetOfParameters const* prms,
  ...
  //-- Class attributes
        ...
        static MY_PLIC_Advection const* PROTOTYPE ;
