...
MODULE FE_OneStepIteration#concentration
            concrete_name = "DF_PLIC_Advection"
...
class DF_PLIC_Advection : public FE_OneStepIteration
{
   public: //-----------------------------------------------------------------
   ...
   private: //----------------------------------------------------------------
       ...
       ~DF_PLIC_Advection( void ) ;
        DF_PLIC_Advection( DF_PLIC_Advection const& other ) ;
        DF_PLIC_Advection& operator=( DF_PLIC_Advection const& other ) ;

        DF_PLIC_Advection( PEL_Object* a_owner,
   ...
   //-- Plug in
        ...
        virtual DF_PLIC_Advection* create_replica( PEL_Object* a_owner,
				      PDE_DomainAndFields const* dom,
				      FE_SetOfParameters const* prms,
  ...
  //-- Class attributes
        ...
        static DF_PLIC_Advection const* PROTOTYPE ;
