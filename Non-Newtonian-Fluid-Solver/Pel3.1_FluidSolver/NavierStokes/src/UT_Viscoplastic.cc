...
/*----------------------------------------------------------------------*/
void UT_Viscoplastic::compute_strain_rate_tensor( PDE_LocalFEcell* cFE,
        PDE_DiscreteField const* UU,
        PDE_DiscreteField* gammadot)
{
    PEL_LABEL( "UT_Viscoplastic:: compute_strain_rate_tensor" ) ;
    ...
    else
    {
        ...
        cout << "    UT_Viscoplastic:: compute_strain_rate_tensor !!!" << endl;
        PEL_Error::exit();
    }
 ...
 */
/*------------------------------------------------------------------------*/
pair<size_t,double> UT_Viscoplastic::strain_rate_component_number(
    size_t const &dimension,
    size_t const& compIdx, size_t const &direcIdx )
{
    PEL_LABEL( "UT_Viscoplastic:: strain_rate_component_number" ) ;
    ...
    if (dimension == 2)
    {
        ...
        case 2 :
            ...
            break;
        default :
			PEL::out() << "Error in UT_Viscoplastic:: strain_rate_component_number " << std::endl;
        	PEL_Error:: exit() ;
        }
    }
    else if (dimension == 3)
    ...
    else
    {
        cout << "!!! Dimension should be either 2 or 3" << endl;
        cout << "    Dimension " << dimension << " is not allowed in " << endl;
        cout << "    UT_Viscoplastic:: strain_rate_component_number !!!" << endl;
        PEL_Error::exit();
    }
...
//-------------------------------------------------------------
void UT_Viscoplastic::update_Lagrange_multiplier( PDE_LocalFEcell* cFE,
        PDE_DiscreteField* LAMBDA,
        PDE_DiscreteField const* gammadot,
        PDE_DiscreteField const* gamma,
        double const& aug_param)
{
    PEL_LABEL( "UT_Viscoplastic:: update_Lagrange_multiplier" ) ;
...
*/
/*-----------------------------------------------------------*/
void UT_Viscoplastic::update_strain_rate_tensor_d( PDE_LocalFEcell* cFE,
...
{
    PEL_LABEL( "UT_Viscoplastic:: update_strain_rate_tensor_d" ) ;
...
*/
/*-----------------------------------------------------------*/
void UT_Viscoplastic::update_strain_rate_tensor_d_HB( PDE_LocalFEcell* cFE,
        PDE_DiscreteField const* LAMBDA,
        PDE_DiscreteField const* gammadot,
        PDE_DiscreteField* gamma,
        double const& aug_param,
...
*/
/*---------------------------------------------------------------------*/
double UT_Viscoplastic::Euclidian_norm( doubleVector const& tensor )
{
    PEL_LABEL( "UT_Viscoplastic:: Euclidian_norm" ) ;
    ...
    else
    {
        ...
        cout << " in" << endl;
        cout << "    UT_Viscoplastic:: Euclidian_norm !!!" << endl;
        PEL_Error::exit();
    }
...
/*------------------------------------------------------------*/
double UT_Viscoplastic::compute_norm_Dminusd( PDE_LocalFEcell* cFE,
        PDE_DiscreteField const* DUU,
        PDE_DiscreteField const* d)
{
    PEL_LABEL( "UT_Viscoplastic:: compute_norm_Dminusd" ) ;
