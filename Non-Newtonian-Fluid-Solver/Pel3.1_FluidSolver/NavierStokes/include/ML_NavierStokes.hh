#ifndef ML_NavierStokes_HH
#define ML_NavierStokes_HH
...
/** \class ML_NavierStokes
    \brief
 *  Adjusted version of
 *  pelicans-3.1.0/ExamplesOfApplication/FSI/src/AP_FSINavierStokes
 *
 *  \note For the implementation structure see
 *  <a href="../../NavierStokes/doc/ImplStructure_ML_NavierStokes.html"> ImplStructure_ML_NavierStokes.html </a>
 *
PUBLISHED
*/

class ML_NavierStokes : public FE_OneStepIteration
{
   public: //-----------------------------------------------------------------
   ...
   //@{
     ~ML_NavierStokes( void ) ;
      ML_NavierStokes( ML_NavierStokes const& other ) ;
      ML_NavierStokes& operator=( ML_NavierStokes const& other ) ;

      ML_NavierStokes( PEL_Object* a_owner,
   ...
   //@{
      ...
      virtual ML_NavierStokes* create_replica(
                                   PEL_Object* a_owner,
                                   PDE_DomainAndFields const* dom,
                                   FE_SetOfParameters const* prms,
   ...
   //-- Class attributes
      ...
      static ML_NavierStokes const* PROTOTYPE ;
