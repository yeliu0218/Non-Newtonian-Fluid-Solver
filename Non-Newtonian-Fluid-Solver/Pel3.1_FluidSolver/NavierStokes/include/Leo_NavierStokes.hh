#ifndef Leo_NavierStokes_HH
#define Leo_NavierStokes_HH
...
/** \class Leo_NavierStokes
    \brief
 *  Adjusted version of
 *  pelicans-3.1.0/ExamplesOfApplication/FSI/src/AP_FSINavierStokes
 *
 *  \note For the implementation structure see
 *  <a href="../../NavierStokes/doc/ImplStructure_Leo_NavierStokes.html"> ImplStructure_Leo_NavierStokes.html </a>
 *
PUBLISHED
*/

class Leo_NavierStokes : public FE_OneStepIteration
{
   public: //-----------------------------------------------------------------
   ...
   //@{
     ~Leo_NavierStokes( void ) ;
      Leo_NavierStokes( Leo_NavierStokes const& other ) ;
      Leo_NavierStokes& operator=( Leo_NavierStokes const& other ) ;

      Leo_NavierStokes( PEL_Object* a_owner,
   ...
   //@{
      ...
      virtual Leo_NavierStokes* create_replica(
                                   PEL_Object* a_owner,
                                   PDE_DomainAndFields const* dom,
                                   FE_SetOfParameters const* prms,
   ...
   //-- Class attributes
      ...
      static Leo_NavierStokes const* PROTOTYPE ;
