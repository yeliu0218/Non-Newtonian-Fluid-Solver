#ifndef UT_Viscoplastic_HH
#define UT_Viscoplastic_HH
...
/** @brief The Class UT_Viscoplastic.
...
private: //----------------------------------------------------------------
    ...
    //@{
    /** @brief Destructor */
    ~UT_Viscoplastic( void ) {}

    /** @brief Copy constructor */
    UT_Viscoplastic( UT_Viscoplastic const& other ) {}
