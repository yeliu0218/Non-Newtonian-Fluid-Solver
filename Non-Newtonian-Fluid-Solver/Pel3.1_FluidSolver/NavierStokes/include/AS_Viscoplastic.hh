#ifndef AS_Viscoplastic_HH
#define AS_Viscoplastic_HH
...
/** @brief The Class AS_Viscoplastic.
...
private: //----------------------------------------------------------------
    ...
    //@{
    /** @brief Destructor */
    ~AS_Viscoplastic( void ) {}

    /** @brief Copy constructor */
    AS_Viscoplastic( AS_Viscoplastic const& other ) {}
